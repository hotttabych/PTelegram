...
public class CheckBoxThreeStateCell extends FrameLayout {

    private TextView textView;
    private TextView valueTextView;
    private CheckBoxSquareThreeState checkBox;
    ...
    public CheckBoxThreeStateCell(Context context, int type) {
        this(context, type, 17);
    }

    public CheckBoxThreeStateCell(Context context, int type, int padding) {
        super(context);
        ...
        checkBox = new CheckBoxSquareThreeState(context, type == 1 || type == 5);
        checkBoxSize = 18;
        if (type == 5) {
    ...
    public void setText(CharSequence text, String value, CheckBoxSquareThreeState.State state, boolean divider) {
    ...
    public void setState(CheckBoxSquareThreeState.State state, boolean animated) {
        checkBox.setState(state, animated);
    }

    public CheckBoxSquareThreeState.State getState() {
    ...
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        ...
        info.setChecked(getState() != CheckBoxSquareThreeState.State.UNCHECKED);
    }
}
